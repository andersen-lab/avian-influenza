...
for gene in "${genes[@]}"; do
	...
	samtools mpileup --reference ../../ref/gisaid_epiflu_sequence.fasta -r $gene -A -d 0 -aa -Q 0 ${n}.bam | ~/code/ivar/build/bin/ivar variants -p variants/${n}_${prefixGene}_variants -t 0.01 -m 1
done
